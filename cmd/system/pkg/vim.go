...
autocmd BufNewFile *.h,*.c,*.sh exec ":call SetTitle()"
...
func SetTitle()
	...
	if &filetype == 'sh'
		...
		call append(line(".")+1, "\# Author: clibing")
		call append(line(".")+2, "\# mail: wmsjhappy@@gmail.com")
	...
	if &filetype == 'cpp'
		call append(line(".")+6, "")
		call append(line(".")+7, "#ifndef __".expand("%:t:r")."__")
		call append(line(".")+8, "#define __".expand("%:t:r")."__")
		call append(line(".")+9, "")
		call append(line(".")+10, "")
		call append(line(".")+11, "")
